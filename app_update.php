            ...
            <div class="col-lg-12"><!--- col-lg-12 Starts --->
                ...
                <div class="card mb-5"><!--- card mb-5 Starts --->
                    ...
                    <div class="card-header"><!--- card-header Starts --->
                        ...
                        <i class="fa fa-money fa-fw"></i> Application Information
                    ...
                    <div class="card-body p-0"><!--- card-body Starts --->
                        ...
                        <form action="" method="post" enctype="multipart/form-data"><!--- form Starts --->
                            ...
                            <a href="<?php echo $site_url; ?>" target="_blank" style="color: green;"><?php echo $site_url; ?></a>
...
$version = file_get_contents("updator/version.txt");

if (!file_exists("updator/version.txt") or !file_exists("updator/update.sql") or !file_exists("updator/files.zip")) {
