  ...
  <div class="card">
    ...
    <div class="card-body"><!--- card-body Starts --->
      ...
      if(isset($_GET['completed_transactions'])){
        $page = $_GET['completed_transactions'];
      if($page == 0){ $page = 1; }
      }else{
       $page = 1;
      }
      ...
      <div class="table-responsive"><!--- table-responsive Starts --->
        <table class="table table-bordered" style="min-height: 200px;">
          ...
          ?>
            ...
            <td><?php echo $seller->seller_user_name; ?></td>
            <td><?php echo $seller->seller_email; ?></td>
            <td><?php echo ucfirst($method); ?></td>
            <td><?php echo $s_currency.$amount; ?></td>
            <td width="180px;">
              ...
              <div class="dropdown-menu"><!--- dropdown-menu Starts --->
                <a class="dropdown-item" href="index?single_seller=<?php echo $seller_id; ?>">
                  <i class="fa fa-info-circle"></i> User's Details
                </a>
                <a target="_blank" class="dropdown-item" href="index?seller_login=<?php echo $seller->seller_user_name; ?>">
                  <i class="fa fa-sign-in"></i> Login As <?php echo $seller->seller_user_name; ?>
                </a>
                <?php if($seller->seller_status == "block-ban"){ ?>
                <a class="dropdown-item" href="index?unblock_seller=<?php echo $seller_id; ?>">
                  <i class="fa fa-unlock"></i> Already Banned! Unblock Seller?
                </a>
                <?php }else{ ?>
                <a class="dropdown-item" href="index?ban_seller=<?php echo $seller_id; ?>">
